...
# Caution: this setting can cause issues with multiline prompts in zsh < 5.7.1 (see #576>
...
alias tfkill="terraform apply -destroy -auto-approve"
alias tfimport="terraform import"
alias tfmove="terraform state mv"
